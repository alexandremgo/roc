...
public:
    ...
    //! Set IPv4 address of the interface on which to join the multicast group.
    bool set_miface_ipv4(const char* iface);

    //! Set IPv6 address of the interface on which to join the multicast group.
    ...
    //! Check whether IP address of the interface on which to join the
    ...
    //! Get IP address of the interface on which to join the multicast group.
